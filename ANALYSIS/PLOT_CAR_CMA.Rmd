...
## Analises:
Quantidade de area total, separados em p,m,g e porcentagem
Quantidade total de imoveis, separados em p,m,g e porcentagem
...
```{r}
obj<- CMA_car[CMA_car@data$NUM_AREA > 330.000000,]
sum(obj@data$NUM_AREA)
```
